...
AHORCADO = ['''
    ...
    =========''', '''
     ...
     | |  |
          |
    =========''']
palabras = """valoracion aprenderpython comida juego python web
imposible variable curso volador cabeza reproductor mirada escritor
billete lapicero celular valor revista gratuito disco voleibol anillo
estrella""".split()
...
def elije_letra(algunaLetra):
    ...
    Esta función hace que el jugador ingrese una letra y
...
while True:
    ...
    if letra in palabraSecreta:
        ...
        # Comprueba la cantidad de letras que ha ingresado el
        # jugador y si perdió
